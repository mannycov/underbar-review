  ...
  describe('Part I', function() {
    ...
    describe('each', function() {
      ...
      it('should only iterate over numeric keys of an array, not all properties', function() {
        ...
        expect(iterations).to.not.include('Do not iterate over me!'); // CHECK THIS BACK WITH HELP DESK LATER, WHY THIS PASSES?
      });
    ...
    describe('map', function() {
      ...
      var iterator = function(num) {
        ...
        expect(_.map(input, iterator)).to.eql([2, 4, 6]);
      })
    ...
    describe('reduce', function() {
      ...
      it('should pass items of the array into the iterator from left to right', function() { //CHECK WHAT 'MEMO' AND '10' IS FOR HERE FOR, AND WHY THIS REDUCE FUNCTION RETURNS THE SAME ARRAY.
        var orderTraversed = [];
/*
      ...
      it('should check that the accumulator is 0 and returns 0 when the items are multiplied', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
